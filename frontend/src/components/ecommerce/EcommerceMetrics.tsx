...
export const EcommerceMetrics = ({ stats }: EcommerceMetricsProps) => {
  ...
  // Estimate balance at risk: fraud transactions * avg score as a rough proxy
  // You can replace this with a real endpoint later
  const balanceAtRisk = stats
    ? (fraudCount * avgScore * 2000).toLocaleString("en-MY", {
