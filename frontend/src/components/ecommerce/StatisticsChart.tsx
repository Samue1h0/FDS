...
export default function StatisticsChart({ trend }: StatisticsChartProps) {
  // Sort by date and extract labels + series data
  const sorted = [...trend].sort((a, b) => a.date.localeCompare(b.date));

  // If we have data, use it. Otherwise fall back to empty placeholders.
      ...
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div className="w-full">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Daily fraud vs legitimate transactions
          </p>
        </div>
